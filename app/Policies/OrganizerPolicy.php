...
class OrganizerPolicy
{
     ...
     */
    public function view(User $user, Organizer $model): bool
    {
     ...
     */
    public function update(User $user, Organizer $model): bool
    {
     ...
     */
    public function delete(User $user, Organizer $model): bool
    {
     ...
     */
    public function restore(User $user, Organizer $model): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, Organizer $model): bool
    {
        return false;
    }
}
