        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-partials.card>
                ...
                <div class="mt-4 px-4">
                    ...
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.users.inputs.ic_no')
                        </h5>
                        <span>{{ $user->ic_no ?? '-' }}</span>
                    </div>
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                    ...
                    <div class="mb-4">
                        ...
                        <span>{{ optional($user->gender)->name ?? '-' }}</span>
                    </div>
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                    ...
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.users.inputs.world_city_id')
                        </h5>
                        <span>{{ $user->world_city_id ?? '-' }}</span>
                    </div>
                    <div class="mb-4">
                        <h5 class="font-medium text-gray-700">
                            @lang('crud.users.inputs.world_division_id')
                        </h5>
                        <span>{{ $user->world_division_id ?? '-' }}</span>
                    </div>
                </div>
