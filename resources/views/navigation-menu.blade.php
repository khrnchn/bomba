        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        @endcan
                        @can('view-any', App\Models\Check::class)
                        <x-dropdown-link href="{{ route('checks.index') }}">
                        Checks
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Counter::class)
                        ...
                        @endcan
                        @can('view-any', App\Models\ManualPayment::class)
                        <x-dropdown-link href="{{ route('manual-payments.index') }}">
                        Manual Payments
                        </x-dropdown-link>
                        @endcan
                        ...
                        @endcan
                        @can('view-any', App\Models\Staff::class)
                        <x-dropdown-link href="{{ route('all-staff.index') }}">
                        All Staff
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Organizer::class)
                        <x-dropdown-link href="{{ route('organizers.index') }}">
                        Organizers
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\OnlinePayment::class)
                        <x-dropdown-link href="{{ route('online-payments.index') }}">
                        Online Payments
                        </x-dropdown-link>
                        @endcan
                </x-nav-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\Announcement::class)
                <x-jet-responsive-nav-link href="{{ route('announcements.index') }}">
                Announcements
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Check::class)
                <x-jet-responsive-nav-link href="{{ route('checks.index') }}">
                Checks
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Counter::class)
                <x-jet-responsive-nav-link href="{{ route('counters.index') }}">
                Counters
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Feedback::class)
                ...
                @endcan
                @can('view-any', App\Models\ManualPayment::class)
                <x-jet-responsive-nav-link href="{{ route('manual-payments.index') }}">
                Manual Payments
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\User::class)
                ...
                @endcan
                @can('view-any', App\Models\Staff::class)
                <x-jet-responsive-nav-link href="{{ route('all-staff.index') }}">
                All Staff
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Organizer::class)
                <x-jet-responsive-nav-link href="{{ route('organizers.index') }}">
                Organizers
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\OnlinePayment::class)
                <x-jet-responsive-nav-link href="{{ route('online-payments.index') }}">
                Online Payments
                </x-jet-responsive-nav-link>
                @endcan
